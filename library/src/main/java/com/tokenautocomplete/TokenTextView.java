 ...
 *
 * @attr ref R.styleable#TokenTextView_tokenTextColor
 * @attr ref R.styleable#TokenTextView_tokenBackground
 * @attr ref R.styleable#TokenTextView_tokenPaddingTop
 * @attr ref R.styleable#TokenTextView_tokenPaddingLeft
 * @attr ref R.styleable#TokenTextView_tokenPaddingRight
 * @attr ref R.styleable#TokenTextView_tokenPaddingBottom
 * @attr ref R.styleable#TokenTextView_tokenMaxLines
 * @attr ref R.styleable#TokenTextView_ellipsize
 */
public class TokenTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = theme.obtainStyledAttributes(
                attrs, R.styleable.TokenTextView, defStyle, R.style.TokeyStyle);
